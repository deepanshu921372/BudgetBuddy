            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  >
                    {showPassword ? (
                      <svg className="h-5 w-5 cursor-pointer text-gray-500" fill="none" viewBox="0 0 24 24" stroke="currentColor">
              ...
              <div className="flex items-center justify-between">
                <div className="flex items-center">
                  <input
                    type="checkbox"
                    id="remember"
                    className="h-4 w-4 cursor-pointer text-purple-600 focus:ring-purple-500 border-purple-100 rounded"
                    disabled={loading}
                  />
              ...
              <Button
                type="submit"
                variant="primary"
                className="w-full cursor-pointer py-3 bg-gradient-to-r from-violet-600 to-purple-600 hover:from-violet-700 hover:to-purple-700"
                disabled={loading}
              >
                {loading ? (
